...
import { Brain, User, Mail, Lock, Eye, EyeOff, Globe, ChevronDown, ArrowRight, ArrowLeft, Check, Loader2, Shield } from "lucide-react";
    ...
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div className="hidden lg:flex flex-col justify-between p-12 bg-primary text-primary-foreground relative overflow-hidden">
        ...
        <div className="relative z-10">
          <p className="text-2xl md:text-3xl font-medium leading-relaxed">
            "MindBridge gave me the courage to seek help. The AI understood my struggles in a way I never expected."
          </p>
          <div className="mt-8 flex items-center gap-4">
            <div className="w-16 h-16 rounded-full bg-primary-foreground/20 flex items-center justify-center text-lg font-bold">PS</div>
            <div>
              <p className="font-semibold">Priya Sharma</p>
              <p className="text-sm opacity-90">Mental Wellness Advocate</p>
            </div>
          </div>
          <div className="mt-12 space-y-4">
            {["24/7 AI support in your language", "100% confidential", "Smart triage system", "Mood analytics"].map((t) => (
      ...
      <div className="flex items-center justify-center p-6 md:p-12 bg-background">
        ...
        >
          ...
          <p className="text-muted-foreground mb-8">Start your mental wellness journey today</p>
